...
function AssignStartingPlots:BalanceAndAssign()
  ...
  local playerList, outerList, middleList = {}, {}, {};
  ...
  for region_number, player_ID in ipairs(middleListShuffled) do
    ...
    local x = math.floor((iW / 2) + (offset * math.cos((math.pi * 2) / i)))
    local y = math.floor((iH / 2) + (offset * math.sin((math.pi * 2) / i)))
